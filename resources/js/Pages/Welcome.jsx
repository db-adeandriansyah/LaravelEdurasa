...
export default function Welcome({ auth, canLogin,laravelVersion, phpVersion }) {
    ...
    console.log('nilai auth pada welcome.jsx',auth)
    console.log('nilai arguments pada welcome.jsx',arguments)
    console.log('nilai caanLogin',canLogin)
                        ...
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    ...
                                    <>
                                        <Link
                                            href={canLogin?route('login'):'/login'}
